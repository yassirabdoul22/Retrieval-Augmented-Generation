"""Abstract base for chunking strategies (Strategy + Template Method)."""
...
class Chunker(ABC):
    """Base class extended by CodeChunker and MarkdownChunker."""

    def __init__(self, max_chunk_size: int) -> None:
        self.max_chunk_size = max_chunk_size

    def chunk(self, file_path: str, content: str) -> List[Chunk]:
        """Chunk a file's content, respecting max_chunk_size."""
    ...
    def _parse(self, file_path: str, content: str) -> List[Chunk]:
        """Split content into raw chunks, not yet limited in size."""

    def _enforce_max_size(self, units: List[Chunk]) -> List[Chunk]:
        """Re-split any chunk longer than max_chunk_size into smaller ones."""
